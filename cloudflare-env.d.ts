/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6fc95fcbb469e6835408462eb605c018)
// Runtime types generated with workerd@1.20260317.1 2026-03-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "VoteIndexerDO";
	}
	interface Env {
		ASSETS: Fetcher;
		VOTE_INDEXER: DurableObjectNamespace<import("./worker").VoteIndexerDO>;
